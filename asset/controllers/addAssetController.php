...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $data = [
        ...
        "serial-number" => !empty(trim($formData['serial-number'])) ? trim($formData['serial-number']) : null,
        "license-key" => !empty(trim($formData['license-key'])) ? trim($formData['license-key']) : null,
