...
class AuthenticationModel
{
    ...
    {
        $query = "select emp_id,username, first_name, email, password_hash, is_admin from employee where email = ? or username = ? or phone = ?";
    ...
    {
        $query = "select emp_id, username, first_name, email, is_admin from employee where session_cookie = ?";
